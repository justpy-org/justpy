...
Demo("{self.name}", {args}"""
    ...
    def same_as_tutorial(self,tutorial_source:ExampleSource,debug:bool=True):
        """
        ...
        for i,diff_line in enumerate(diff):
            if i==0:
                if not diff_line.startswith("+ # Justpy Tutorial demo"):
                    problems.append("comment in line 1 missing")
