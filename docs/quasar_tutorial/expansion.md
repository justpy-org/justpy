...
def expansion_test(request):
    ...
    add_btn = jp.QButton(label='Add Image', classes="q-mb-md", color='primary', a=d)
    close_btn = jp.QButton(label='Close All', classes="q-ml-md q-mb-md", color='negative', a=d)
    open_btn = jp.QButton(label='Open All', classes="q-ml-md q-mb-md", color='positive', a=d)
